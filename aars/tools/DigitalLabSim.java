...
import aars.mips.hardware.Coprocessor0;
        ...
        if (CounterInterruptOnOff)
            if (CounterValue > 0) {
                ...
                if ((Coprocessor0.getValue(Coprocessor0.STATUS) & 2) == 0) {
                    aars.simulator.Simulator.externalInterruptingDevice = /*Exceptions.*/EXTERNAL_INTERRUPT_TIMER;
                }
            }
    }
            ...
            public void mouseClicked(MouseEvent arg0) {
                ...
                if (KeyBoardValueButtonClick != -1) {//Button already pressed -> now realease
                    ...
                    if (KeyboardInterruptOnOff && (Coprocessor0.getValue(Coprocessor0.STATUS) & 2) == 0) {
                        aars.simulator.Simulator.externalInterruptingDevice = /*Exceptions.*/EXTERNAL_INTERRUPT_HEXA_KEYBOARD;
                    }
                }
            }
        }
