...
package aars.venus.editors.jeditsyntax;

import aars.Settings;
...
public class TextAreaDefaults {
    ...
    public static TextAreaDefaults getDefaults() {
        ...
        DEFAULTS.caretBlinks = (aars.Globals.getSettings().getCaretBlinkRate() != 0);
        DEFAULTS.caretBlinkRate = aars.Globals.getSettings().getCaretBlinkRate();
        DEFAULTS.tabSize = aars.Globals.getSettings().getEditorTabSize();
        ...
        DEFAULTS.lineHighlight = aars.Globals.getSettings().getBooleanSetting(Settings.EDITOR_CURRENT_LINE_HIGHLIGHTING);
